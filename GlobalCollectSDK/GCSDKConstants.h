...
#ifndef GlobalCollectSDK_GCSDKConstants_h
#define GlobalCollectSDK_GCSDKConstants_h

//Keys
#define kGCSDKLocalizable           @"GCSDKLocalizable"
#define kGCImageMapping             @"kGCImageMapping"
#define kGCImageMappingInitialized  @"kGCImageMappingInitialized"
#define kGCIINMapping               @"kGCIINMapping"
